// This file mostly exists because we want dev mode to say "Naso Code Lab (Dev)" instead of "electron"
...
const APP_DISPLAY_NAME = isDevelopment ? "Naso Code Lab (Dev)" : "Naso Code Lab (Alpha)";
const APP_BUNDLE_ID = isDevelopment
  ? "com.nasooholabi.nasocodelab.dev"
  : "com.nasooholabi.nasocodelab";
